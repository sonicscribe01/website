...
const plans = [
  {
    name: 'Basic',
    price: '$9.99',
    features: ['30 minutes of transcription per month', 'Basic editing tools', 'Email support'],
  },
  {
    name: 'Pro',
    price: '$24.99',
    features: ['2 hours of transcription per month', 'Advanced editing tools', 'Priority email support', 'API access'],
  },
  {
    name: 'Enterprise',
    price: 'Custom',
    features: ['Unlimited transcription', 'Full suite of editing tools', 'Dedicated account manager', 'Custom API integration'],
  },
]
