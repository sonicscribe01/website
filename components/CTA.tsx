...
const textGlow = keyframes`
  0% { text-shadow: 0 0 10px rgba(255, 69, 0, 0.5), 0 0 20px rgba(255, 69, 0, 0.3); }
  50% { text-shadow: 0 0 20px rgba(255, 69, 0, 0.7), 0 0 30px rgba(255, 69, 0, 0.5); }
  100% { text-shadow: 0 0 10px rgba(255, 69, 0, 0.5), 0 0 20px rgba(255, 69, 0, 0.3); }
`;
