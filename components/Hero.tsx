      ...
      <div className="max-w-2xl mx-auto bg-gradient-to-br from-[#2A2A2A] to-[#1A1A1A] p-8 rounded-lg shadow-2xl transition-all duration-300 ease-in-out hover:shadow-3xl hover:from-[#3A3A3A] hover:to-[#2A2A2A] border border-gray-700">
        ...
        <div className="bg-[#0A0A0A] p-6 rounded-lg mb-6">
          <div className="flex flex-col items-center">
            ...
            >
              <Mic className={`w-6 h-6 transition-all duration-300 ${isRecording ? 'text-white' : 'text-[#FF4500]'}`} aria-hidden="true" />
            </Button>
        ...
        {transcription && (
          <div className="mt-6 text-left">
            <h3 className="text-xl font-semibold mb-2 text-white">Real-time Transcription</h3>
            ...
            {selectedLanguage && (
              <>
                <h3 className="text-xl font-semibold mb-2 text-white">Real-time Translation</h3>
            ...
            <div className="mt-4 space-y-4">
              ...
              {keyPoints.length > 0 && (
                <div>
                  <h4 className="text-lg font-semibold mb-2 text-white">Key Points</h4>
              ...
              {translatedText && (
                <div>
                  <h4 className="text-lg font-semibold mb-2 text-white">Translation</h4>
            ...
            {!isRecording && transcription && (
              <div className="mt-6 space-y-4">
                <h3 className="text-xl font-semibold mb-2 text-white">Actions</h3>
