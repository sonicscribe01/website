  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-[#111111] to-[#1A1A1A] text-white border-[#FF4500]/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4" aria-label="Early Access Request Form">
          ...
          <div className="space-y-2" role="group" aria-label="User type selection">
          ...
          <DialogFooter>
            <Button type="submit" className="w-full bg-[#FF4500] hover:bg-[#FF6347] text-white" aria-label="Submit early access request">
              Get Early Access
            </Button>
          </DialogFooter>
        </form>
